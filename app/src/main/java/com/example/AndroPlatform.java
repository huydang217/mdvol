...
public class AndroPlatform extends Python.Platform {
    ...
    /**
     * Uses the {@link android.app.Application} context of the given context to initialize Python.
     */
    public AndroPlatform(@NotNull Context context) {
        ...
        if (ABI == null) {
            throw new RuntimeException(
                    "None of this device's ABIs " + supportedAbis + " are supported by this app.");
        }
    }
     ...
     * {@code native.stdout} and {@code native.stderr} respectively. This may be useful for
     * debugging the Python startup process, or seeing messages produced by non-Python libraries.
     *
     * <p>This method has no effect on stdin. It also has no effect on Python's {@code sys.stdout}
     * and {@code sys.stderr}, which are always redirected as described <a
     * href="../../../../../android.html#sys">here</a>.
     */
    ...
    public void onStart(@NotNull Python py) {
        ...
        String[] appPath = {
            Common.ASSET_APP, Common.ASSET_REQUIREMENTS, Common.ASSET_STDLIB + "-" + ABI,
        };
    ...
    private void extractAsset(JSONObject assetsJson, SharedPreferences.Editor spe, String path)
    ...
    /**
     * This converts all newlines to "\n", and adds a newline at the end of the stream even if none
     * was present, but neither of those things should matter for a text file.
     */
